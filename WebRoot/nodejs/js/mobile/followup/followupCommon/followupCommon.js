...
exports.to_followUp_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/followUp.html');
    console.log("进入时间"+new Date());
};

//跳转到已完成随访页面
exports.to_finishFollow_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/finishFollow.html');
};

//跳转到宣教页面
exports.to_education_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/education.html');
};

//跳转到处理随访任务页面
exports.to_processingFollowupCommon_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/processingFollowupCommon.html');
};

//跳转到查看随访任务页面
exports.to_checkFollowupCommon_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/checkFollowupCommon.html');
};

//跳转到随访计划详情页面
exports.to_followupPlanDetail_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/followupPlanDetail.html');
};

//跳转到结案页面
exports.to_closeCase_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/closeCase.html');
};
...
exports.query_followUp_data=function(){
    ...
    _t.postAjax("/hug-web/r/followUp/1002","获取当日随访任务列表",query,headers,null);
...
exports.to_medicalRecordList_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/medicalRecordList.html');
};
//根据卡号刷新医疗数据
...
exports.to_educationDetail_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/educationDetail.html');
};
//查询宣教列表
...
exports.to_educationSelect_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/educationSelect.html');
};
// 查宣教列表
...
exports.to_phoneTest_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/test.html');
    console.log("进入时间"+new Date());
};
//跳转到查看随访任务页面
exports.to_skipFirst_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/skipFirst.html');
};
// 跳转到个人绑定
exports.to_bindAccount_page = function(){
    this.render('../../web-bin/mobile/followup/followupCommon/bindAccount.html');
};
//绑定随访
