...
function(a) {
    ...
    c.orien = function(a, b) {
        ...
        //css属性传进去
        c.options.css&&c.options.css.left?(a.style.left=c.options.css.left + "px"):(a.style.left = e.left + (b ? 0 : c.scroll(1)) + "px");
        ...
        c.options.css&&c.options.css.top?(a.style.top=c.options.css.top):null;
        //cssEvent属性传进去，覆盖css
        var m=c.options.cssEvent&&c.options.cssEvent(e,{});
        m!=null&&m.left?a.style.left = m.left+"px":null;
        m!=null&&m.top?a.style.top = m.top+"px":null;
    ...
    c.events = function() {
        ...
        function() {
            ...
            "function" == typeof c.options.choose && c.options.choose(c.elem[h.elemv]);
            c.close()
        }),
        h.ok = b("#laydate_ok"),
        c.on(h.ok, "click",
