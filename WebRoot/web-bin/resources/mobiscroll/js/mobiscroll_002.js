    ...
    function Scroller(elem, settings) {
        ...
        function position(check) {
            ...
            if (s.display == 'modal') {
                ...
                t = st + (wh - mh) / 2;
                if(s.preset=="date"){
                    t=$(window).height()*0.5-145;
                }else if(s.preset=="datetime"){
                    t=$(window).height()*0.5-250;
                }
            ...
            $(e).blur();//去掉时间选择框的focus事件，可解决ios11出现的点击无效bug
            css.top = t < 0 ? 0 : t;
            css.left = l;
            d.css(css);
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi '+s.preset+ '"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="'+s.preset+' dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="dwv"></div>' : ''));
