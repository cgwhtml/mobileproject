...
(function ($) {
                ...
                */
                formatResult: function (d) {
                	if(s.dateFormat=="nn"){
                		...
                		var numText=[s.numText1,s.numText2,s.numText3,s.numText4,s.numText5];
    ...
    $.each(['date', 'time', 'datetime','num'], function (i, v) {
        ms.presets[v] = preset;
        ms.presetShort(v);
    });
