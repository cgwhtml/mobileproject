            ...
            function onRequest() {
            	...
            	/*if(navigator.userAgent.indexOf("MSIE 8.0")>0||navigator.userAgent.indexOf("MSIE 9.0")>0){
                    ...
                    function createPageBar(data) {
                        ...
                        if(opts.pageObj){
                            opts.pageCount = parseInt((eval("data."+opts.pageObj).totalCount-1)/opts.pageNumber)+1;
                            opts.dataTotal = eval("data."+opts.pageObj).totalCount;
                        }else{
                        	var totalCount=data.data!=null?data.data.totalCount:1;
