...
$(function(){
    $("#submit").click(function () {
        ...
        $.ajax({
            ...
            timeout:60000,
            type:"get",
            url: LOCALHOST_URL+'/web-bin/m/followup/followupCommon/submit_closeCase_data?usId='+query.usId+'&accessToken='+query.accessToken+'&partnerType='+partnerType+'&empiId='+query.empiId+'&planId='+query.planId+'&closeDesc='+closeDesc,
            dataType:"json",
