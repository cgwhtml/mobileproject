...
$(function(){
    ...
    if(inHosNo!=""){
        ...
        $.ajax({
            on: false,
            type:"get",
            url: LOCALHOST_URL+'/web-bin/m/followup/followupCommon/get_medicalRecordList_data?hospCard='+inHosNo+"&hospCode="+hospCode+'&usId='+query.usId+'&accessToken='+query.accessToken+'&partnerType='+partnerType+"&cardType=2",
            dataType:"json",
        ...
        $.ajax({
            on: false,
            type:"get",
            url: LOCALHOST_URL+'/web-bin/m/followup/followupCommon/get_medicalRecordList_data?hospCard='+visitCardNo+"&hospCode="+hospCode+'&usId='+query.usId+'&accessToken='+query.accessToken+'&partnerType='+partnerType+"&cardType=1",
            dataType:"json",
            success: function(data){
                console.log(data);
                num+=1;
                ...
                $.ajax({
                    on: false,
                    type:"get",
                    url: LOCALHOST_URL+'/web-bin/m/followup/followupCommon/get_medicalRecordList_data?hospCard='+visitCardNo+"&hospCode="+hospCode+'&usId='+query.usId+'&accessToken='+query.accessToken+'&partnerType='+partnerType+"&cardType=2",
                    dataType:"json",
                    success: function(data){
                        console.log(data);
                        num+=1;
