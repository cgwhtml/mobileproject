...
$(function(){
    ...
    $.ajax({
        ...
        timeout:60000,
        type:"get",
        url: LOCALHOST_URL+'/web-bin/m/followup/healthCare/query_followupCommon_data?usId='+query.usId+'&accessToken='+query.accessToken+'&partnerType='+partnerType+'&empiId='+query.empiId+'&planId='+query.planId,
        dataType:"json",
    ...
    $("#close_button").click(function () {
        location.href = LOCALHOST_URL+'/web-bin/m/followup/healthCare/to_closeCase_page?usId='+query.usId+'&accessToken='+query.accessToken+'&partnerType='+partnerType+'&empiId='+query.empiId+'&planId='+query.planId+"&hgId="+query.hgId;
    });
});
