                            ...
                            if(data.data.result.length>0){
                                ...
                                for(var j=0;j<res.length;j++){
                                    ...
                                    for(var k=0;k<res[j].id.length;k++){
                                        $(".pat .con_box_list").eq(j).append('<li><div class="education_img"></div><div class="education_span">'+res[j].title[k]+'</div><a class="con_btn"></a><input type="hidden" value="'+res[j].isBack[k]+'" class="isBack"><input type="hidden" class="id" value="'+res[j].id[k]+'"></li>');
                                    }
                                }
                                btnShow();
                            }else{
                        ...
                        if(data.data.result.length>0){
                            ...
                            if(res[0].sendTimeStr==Sarr[Sarr.length-1][Sarr[Sarr.length-1].length-1].sendTimeStr){
                                for(var j=0;j<res[0].id.length;j++) {
                                    ...
                                    $(".pat").siblings("div").find(".con_box_list:last").append('<li><div class="education_img"></div><div class="education_span">'+res[0].title[j]+'</div><a class="con_btn"></a><input type="hidden" value="' + res[0].isBack[j] + '" class="isBack"><input type="hidden" class="id" value="' + res[0].id[j] + '"></li>');
                                }
                                for(var k=1;k<res.length;k++){
                                    ...
                                    for(var v=0;v<res[k].id.length;v++){
                                        $(".pat .con_box_list").eq(k-1).append('<li><div class="education_img"></div><div class="education_span">'+res[k].title[v]+'</div><a class="con_btn"></a><input type="hidden" value="'+res[k].isBack[v]+'" class="isBack"><input type="hidden" class="id" value="'+res[k].id[v]+'"></li>');
                                    }
                                }
                            }else{
                                for(var j=0;j<res.length;j++){
