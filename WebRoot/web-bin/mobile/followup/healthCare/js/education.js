...
$(function(){
    ...
    $.ajax({
        ...
        timeout:60000,
        type:"get",
        url: LOCALHOST_URL+'/web-bin/m/followup/healthCare/query_doctor_power?usId='+usId+'&accessToken='+accessToken+'&partnerType='+partnerType,
        dataType:"json",
...
function callBack3(data){
    ...
    if(data.data.viewAuth == 1){
        url=LOCALHOST_URL+'/web-bin/m/followup/healthCare/query_inHosp_data?usId='+usId+'&accessToken='+accessToken+'&partnerType='+partnerType+"&inhospStatus=false";
        loadData(url);
        return;
    }else{
