...
var urls=LOCALHOST_URL+'/web-bin/m/followup/healthCare/get_educationDetail_data?accessToken='+query.accessToken+'&usId='+query.usId+'&partnerType='+partnerType+"&inhospNo="+query.inhospNo+"&category=6"+"&phone="+phone+"&idCard="+query.idCard+"&patName="+patName;
//禁止iPhone的缩放，弹性滚动
...
$(function(){
   ...
   function  loadEducation() {
       $.ajax({
           on:true,
           type:"get",
           url:LOCALHOST_URL+'/web-bin/m/followup/followupTask/get_patientPhone_data?usId='+query.usId+'&accessToken='+query.accessToken+"&inhospNo="+query.inhospNo+"&inhospSerialNo="+query.inhospSerialNo+"&patIndexNo="+query.patIndexNo+"&patName="+patName,
           dataType:"json",
           success:function(data){
               console.log(data);
               if(data.data&&data.res==0&&data.data.mobileNo){
               ...
               $(".header").click(function(){
                   location.href=LOCALHOST_URL+'/web-bin/m/followup/healthCare/to_medicalRecordList_page?partnerType=11&hugId='+query.hgId+'&name='+patName+'&phone='+phone+'&hospCode='+query.hospCode+'&usId='+query.usId+'&accessToken='+query.accessToken+'&inHosNo=&visitCardNo='+query.visitCardNo+'&sex=';
               });
               $.ajax({
                   on:true,
                   type:"get",
                   url:LOCALHOST_URL+'/web-bin/m/followup/followupTask/get_educationDetail_data?usId='+query.usId+'&accessToken='+query.accessToken+"&patName="+patName+"&inhospNo="+query.inhospNo+"&category=6"+"&phone="+phone+"&idCard="+query.idCard+page,
                   dataType:"json",
