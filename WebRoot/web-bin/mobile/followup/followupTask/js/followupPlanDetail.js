...
$(function(){
    ...
    $.ajax({
        ...
        timeout:60000,
        type:"get",
        url: LOCALHOST_URL+'/web-bin/m/followup/followupTask/query_followupTask_data?usId='+query.usId+'&accessToken='+query.accessToken+'&empiId='+query.empiId+'&planId='+query.planId,
        dataType:"json",
    ...
    $("#close_button").click(function () {
        location.href = LOCALHOST_URL+'/web-bin/m/followup/followupTask/to_closeCase_page?usId='+query.usId+'&accessToken='+query.accessToken+'&eachDate='+query.eachDate+'&empiId='+query.empiId+'&planId='+query.planId+"&corpId="+corpId+"&agentId="+agentId;
    });
});
