...
$(function(){
	...
	$.ajax({
		on: true,
		type:"get",
		url: LOCALHOST_URL+'/web-bin/m/medical/doctor/query_medicalRecordList_data'+query,
		dataType:"json",
    ...
    $.ajax({
        on: true,
        type:"get",
        url: LOCALHOST_URL+'/web-bin/m/medical/doctor/query_patient_data?patId='+query1.patId,
        dataType:"json",
        success: function(data){
            console.log(data);
            CallBack2(data);
...
//		location.href ="/HugPage/web-bin/mobile/medical/doctor/refresh.html"+query;
//	});	
});
...
function CallBack(data){
	if(data!=null && data.data!=null){
		...
		$(".hosp").bind("click",function(){
            ...
            var top="&hideTop=0"+"&hideBasic=0"+"&hideFee=0";
		...
		$("#main_body").html(
				'<div id="none">'+
					'<img src="/web-bin/mobile/medical/doctor/images/prompt_icon_data.png">'+
					'<p>暂无数据</p>'+
				'</div>'
		);
		$("#none").css({
