...
$(function(){
	...
	pagination=$("#page").myPagination({
        ...
        ajax: {
    		...
    		type: "GET",
    		url: localhostUrl+'/web-bin/p/followup/healthMonitor/query_healthMonitorAllList_data?docHugId='+query.hugId+"&hospCode="+query.hospCode,
    		dataType: "json"
    	},
        panel: {
            tipInfo_on: true,
	...
	//根据输入框条件检索用户列表
  	$("#basicQusery").click(function(){
  		...
  		var params = "name="+escape(patName);
